(function () {
    ...
    function renderCombinedTitle(title, movie) {
        ...
        var html = '<div class="plugin-uk-title-combined cardify__details" style="margin-top:10px;margin-bottom:10px;">' +
...
if(rateLine.length){
    ...
    var style = '<style id="studio-logos-combined-style">' +
        ...
        '.cardify__right .studio-logo{display:none !important;}' +
    '</style>';
